        ...
        echo '<div class="col-md-4 mb-4">
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <button class="btn btn-info" data-id="' . $row["event_id"] . '" onclick="showEventDetails(this)">Details</button>
                        <button class="btn btn-danger delete-event" data-id="' . $row["event_id"] . '">Delete</button>
                    </div>
                </div>
              </div>';
    }
